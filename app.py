...
API = IAMAuthenticator("htQj8aeVkZgQe_ACS5wgIes1TyG4_XDD6mBePhjxLlkI")
text_to_speech = TextToSpeechV1(authenticator= API)

text_to_speech.set_service_url("https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/17e6d731-ea69-4c60-9916-35cab3c74596")
...
class Application:
    def __init__(self):
        ...
        print("loaded model model-bw.h5")
    ...
    def action1(self):
    	...
    	if(len(predicts) > 0):
            ...
            self.str+=" "
            self.str+=predicts[0]
            with open("test_it.mp3","wb") as audiofile:
                audiofile.write(text_to_speech.synthesize(self.str,
                                accept = "audio/mp3").get_result().content)
            sound_file = "./test_it.mp3"
    ...
    def action_call(self) :
        ...
        self.photo1 = tk.PhotoImage(file='Pictures/daivik.png')
        ...
        self.tx6.config(text = " Daivik \n 47396202817", font = ("Courier",15,"bold"))

        self.photo2 = tk.PhotoImage(file='Pictures/gajju.png')
        ...
        self.tx2.config(text = " Rishabh \n 48096202817", font = ("Courier",15,"bold"))

        
        self.photo3 = tk.PhotoImage(file='Pictures/prerna_2.png')
        ...
        self.tx3.config(text = "Prerna \n 35996202817", font = ("Courier",15,"bold"))
